# Originally from https://github.com/rcpsilva/BCC325_ArtificialIntelligence/blob/main/2022-1/Constraint%20Satisfaction%20Problems/nQueensLocalSearch.py
...
if __name__ == '__main__':
    ...
    sol, val = local_search(sol, obj, swap, maxit=100000)
